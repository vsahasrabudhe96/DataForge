    ...
    <div className="min-h-screen bg-[var(--background)] grid-pattern flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <Card variant="default" padding="lg" className="space-y-6">
          ...
          {/* Demo Account */}
          <div className="p-4 rounded-xl bg-[var(--accent-cyan)]/10 border border-[var(--accent-cyan)]/20">
            ...
            <p className="text-xs text-[var(--foreground-muted)]">
              Email: <code className="text-[var(--accent-cyan)]">demo@dataforge.app</code>
              <br />
              Password: <code className="text-[var(--accent-cyan)]">demo123</code>
            </p>
          </div>
        </Card>
