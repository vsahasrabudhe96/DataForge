  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        {/* User Avatar */}
        <Link href="/settings">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[var(--accent-cyan)] to-[var(--accent-purple)] flex items-center justify-center cursor-pointer hover:opacity-90 transition-opacity">
