...
export const FLASHCARDS: Flashcard[] = [
  ...
  // ==================== ADDITIONAL BEGINNER ====================
  {
    ...
    category: 'Data Modeling',
    difficulty: 'beginner',
    front: 'What are the three types of relationships in ER modeling?',
    back: '1. One-to-One (1:1) - e.g., Employee to Badge\n2. One-to-Many (1:N) - e.g., Customer to Orders\n3. Many-to-Many (M:N) - e.g., Students to Courses',
    tags: ['er-modeling', 'relationships'],
  },
  {
    id: 'fc-dm-013',
    category: 'Data Modeling',
    difficulty: 'beginner',
    front: 'Why should you use surrogate keys instead of natural keys?',
    back: '1. Immutable - never changes\n2. No business meaning - immune to business changes\n3. Simple integer - efficient joins\n4. Supports SCD Type 2\n5. Handles source system changes',
    tags: ['keys', 'surrogate'],
  },
  {
    id: 'fc-dm-014',
    category: 'Data Modeling',
    difficulty: 'beginner',
    front: 'What is the purpose of denormalization in data warehouses?',
    back: 'To improve query performance by reducing JOINs. Trade-off: increased storage and update complexity for faster reads in OLAP workloads.',
    tags: ['denormalization', 'performance'],
  },
  {
    id: 'fc-dm-015',
    category: 'Data Modeling',
    difficulty: 'beginner',
    front: 'What are the three types of fact tables?',
    back: '1. Transaction Facts - one row per event (most detailed)\n2. Periodic Snapshot - one row per time period per entity\n3. Accumulating Snapshot - one row per lifecycle (updated as process progresses)',
    tags: ['fact-table', 'dimensional'],
  },
  {
    id: 'fc-dm-016',
    ...
    back: 'A dimension key (like order_number) stored directly in the fact table without its own dimension table. Used when the key provides context but has no additional attributes.',
    tags: ['dimensional', 'degenerate-dimension'],
  },
  {
    id: 'fc-dm-017',
    category: 'Data Modeling',
    difficulty: 'beginner',
    front: 'What is measure additivity?',
    back: 'Additive: Can SUM across all dimensions (revenue, quantity)\nSemi-additive: Can SUM across some dimensions (balance - not across time)\nNon-additive: Cannot SUM (ratios, percentages)',
    tags: ['fact-table', 'measures'],
  },
  ...
  // ==================== ADDITIONAL INTERMEDIATE ====================
  {
    ...
    category: 'SCDs',
    difficulty: 'intermediate',
    front: 'What columns are needed for SCD Type 2?',
    back: '1. Surrogate key (unique per version)\n2. Natural key (same across versions)\n3. effective_date (when version started)\n4. expiration_date (when version ended)\n5. is_current flag (TRUE for current row)',
    tags: ['scd', 'type-2'],
  },
  {
    id: 'fc-scd-008',
    category: 'SCDs',
    difficulty: 'intermediate',
    front: 'How does SCD Type 6 combine Types 1, 2, and 3?',
    back: 'Type 2: Multiple rows with effective dates\nType 1: current_* columns updated in ALL rows\nType 3: previous_* columns for last value\nProvides maximum query flexibility at cost of complexity.',
    tags: ['scd', 'type-6', 'hybrid'],
  },
  {
    id: 'fc-load-005',
    category: 'Loading Patterns',
    difficulty: 'intermediate',
    front: 'How does Change Data Capture (CDC) work?',
    back: 'Reads database transaction log (WAL/binlog) to capture INSERT, UPDATE, DELETE events. Minimal source impact, captures deletes, near real-time.',
    tags: ['cdc', 'change-data-capture'],
  },
  {
    id: 'fc-load-006',
    category: 'Loading Patterns',
    ...
    back: 'Running the same operation multiple times produces the same result as running once. Essential for safe retries. Patterns: DELETE-INSERT, MERGE/UPSERT, ON CONFLICT.',
    tags: ['idempotency', 'etl'],
  },
  {
    id: 'fc-load-007',
    category: 'Loading Patterns',
    difficulty: 'intermediate',
    front: 'What is a watermark in incremental loading?',
    back: 'A marker (usually timestamp or ID) tracking the last successfully processed record. Used to resume from where you left off. Store in control table.',
    tags: ['incremental', 'watermark'],
  },
  {
    id: 'fc-load-008',
    category: 'Loading Patterns',
    difficulty: 'intermediate',
    front: 'Full Load vs Incremental Load trade-offs?',
    back: 'Full: Simple logic, guaranteed consistency, slow for large tables\nIncremental: Fast, efficient, complex logic, requires change tracking, may miss deletes',
    tags: ['full-load', 'incremental'],
  },
  ...
  // ==================== ADDITIONAL ADVANCED ====================
  {
    ...
    difficulty: 'advanced',
    front: 'What is a Data Lakehouse?',
    back: 'Architecture combining data lake storage (cheap, flexible) with data warehouse features (ACID, schema enforcement, time travel). Uses Delta Lake, Iceberg, or Hudi.',
    tags: ['lakehouse', 'architecture'],
  },
  {
    id: 'fc-lh-002',
  ...
  },
  {
    ...
    category: 'Lakehouse',
    difficulty: 'advanced',
    front: 'How does Delta Lake provide ACID on object storage?',
    back: 'Uses transaction log (_delta_log) of JSON files tracking all changes. Log is single source of truth. Parquet files are immutable; log tracks which are active.',
  ...
  },
  {
    ...
    category: 'Lakehouse',
    difficulty: 'advanced',
    front: 'Delta Lake: What does OPTIMIZE and Z-ORDER do?',
    back: 'OPTIMIZE: Compacts small files into larger ones (target 128MB-1GB)\nZ-ORDER: Co-locates related data in same files for faster filtering. Use on high-cardinality query columns.',
    tags: ['delta-lake', 'performance'],
  },
  {
    id: 'fc-lh-005',
    category: 'Lakehouse',
    difficulty: 'advanced',
    front: 'Why choose Apache Iceberg over Delta Lake?',
    back: '1. Partition evolution (change without rewriting)\n2. Hidden partitioning (users dont need to know scheme)\n3. Better multi-engine support\n4. Vendor neutral',
    tags: ['iceberg', 'comparison'],
  },
  {
    id: 'fc-dq-006',
    category: 'Data Quality',
    ...
    back: '1. Accuracy - correct representation of reality\n2. Completeness - required data present\n3. Consistency - matches across systems\n4. Timeliness - fresh enough for use\n5. Uniqueness - no duplicates\n6. Validity - conforms to rules/formats',
    tags: ['data-quality', 'dimensions'],
  },
  {
    id: 'fc-dq-007',
    ...
    difficulty: 'advanced',
    front: 'What is a Data Contract?',
    back: 'Formal agreement between data producers and consumers specifying schema, semantics, quality SLAs, and ownership. Prevents breaking changes and ensures data reliability.',
    tags: ['data-contracts', 'governance'],
  },
  {
    id: 'fc-perf-001',
    category: 'Performance',
    difficulty: 'advanced',
    front: 'What makes a query sargable?',
    back: 'SARG = Search ARGument. Query can use indexes. Avoid functions on indexed columns, leading wildcards, implicit conversions. Use: date >= X instead of YEAR(date) = X',
  ...
  },
  {
    ...
    category: 'Performance',
    difficulty: 'advanced',
    front: 'When should you partition a table?',
    back: 'When table is large (>10GB), queries consistently filter on partition column, and each partition has substantial data (1GB+). Common: date partitioning for time-series.',
  ...
  },
  {
    ...
    difficulty: 'advanced',
    front: 'What is a covering index?',
    back: 'Index containing ALL columns needed by a query. Query answered entirely from index without table access. Created with INCLUDE clause in some databases.',
    tags: ['indexing', 'covering-index'],
  },
  {
    id: 'fc-perf-004',
    category: 'Performance',
    difficulty: 'advanced',
    front: 'Composite index column order best practice?',
    back: '1. Equality columns first\n2. Range columns last\n3. Most selective first\nLeftmost prefix rule: (A,B,C) supports WHERE A and WHERE A AND B, not WHERE B alone.',
    tags: ['indexing', 'composite'],
  },
];
